...
declare const _default: import("vue").DefineComponent<{}, {
    query: import("@tanstack/vue-query").UseQueryReturnType<Item[], Error>;
    updateWithArray: () => Promise<void>;
    updateWithSingleItem: () => Promise<void>;
    updateWithArrayAsObject: () => Promise<void>;
    helpers: {
